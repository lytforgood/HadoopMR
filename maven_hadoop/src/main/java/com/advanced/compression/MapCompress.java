...
/**
 * 需打包运行
 * 在map任务输出进行gzip压缩 configuration.setBoolean("mapred.compress.map.output",
 * true); configuration.setClass("mapred.map.output.compression.codec",
...
//				"hdfs://hadoop-master.dragon.org:9000/opt/data/wc/outputmapcompress/" };
		// 获取配置信息
...
//		configuration.setBoolean("mapred.compress.map.output", true);
//		configuration.setClass("mapred.map.output.compression.codec",
//				GzipCodec.class, CompressionCodec.class);
