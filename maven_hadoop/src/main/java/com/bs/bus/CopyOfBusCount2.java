...
public class CopyOfBusCount2 extends Configured implements Tool {
			 ...
			 String pattern = "开始处理板坯号";
		      ...
		      if (m.find( )) {
		    	  if (rr) {
			    	  ...
			    	  myval.set(sb.toString().replaceFirst(",,", ""));
	...
	public static void main(String[] args) throws Exception {
		args = new String[] {
				"hdfs://hadoop-master.dragon.org:9000/opt/taigang",
				// "hdfs://hadoop-00:9000/home910/liyuting/output/" };
				"hdfs://hadoop-master.dragon.org:9000/opt/Matchtest/" };
		// run mapreduce
		int status = ToolRunner.run(new CopyOfBusCount2(), args);
		// 5 exit
		System.exit(status);
	}
}
